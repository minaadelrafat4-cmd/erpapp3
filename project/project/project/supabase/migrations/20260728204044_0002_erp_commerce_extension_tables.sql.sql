...
Adds enterprise tables: profiles, warehouses, inventory_transactions, stock_adjustments,
stock_transfers, payments, invoices, purchase_orders, purchase_order_items, expenses,
reports, activity_logs. All normalized with FKs, indexes, constraints.

## Security
- RLS on every new table.
- profiles: owner read; self update; staff read all.
- ERP tables: staff-only CRUD via is_staff() gate.
