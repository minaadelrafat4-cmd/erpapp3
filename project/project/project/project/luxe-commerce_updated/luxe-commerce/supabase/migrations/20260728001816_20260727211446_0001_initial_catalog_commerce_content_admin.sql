...
Creates the complete data model for a premium vape & smoking e-commerce platform with an
ERP-ready foundation. Tables organized into four groups: CATALOG, COMMERCE, CONTENT, ADMIN/ERP.

## Security
- RLS enabled on EVERY table.
- Public-facing catalog/content tables allow anon+authenticated SELECT.
- Customer-scoped tables use auth.uid() ownership checks with DEFAULT auth.uid() on owner columns.
- Admin/ERP tables are authenticated only.
